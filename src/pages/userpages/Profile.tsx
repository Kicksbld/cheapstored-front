...
const Profile = () => {
    ...
    return (
        <div className="container pb-4">
            <NavBar />
            <div className="max-w-[1338px] px-4 mx-auto pt-[134px] flex flex-col md:flex-row justify-between gap-x-10 gap-y-20">
                        ...
                        {state === 2 && (
                            <>
                                ...
                                <div className="space-y-[20px] w-full md:w-[432px] border border-cloud bg-light rounded-[10px] p-[20px]">
                                    <Typographie theme="secondary" font="ambit" weight="semibold">
                                        #3
                                    </Typographie>
                                    <div className="w-full flex items-center justify-between gap-[15px] flex-wrap">
                                        <Typographie font="cooper" theme="grey">Samedi 17 Nov 2024</Typographie>
                                        <Typographie font="cooper" theme="grey">1 article</Typographie>
                                        <Typographie font="cooper" theme="grey">€ 250.00</Typographie>
                                    </div>
                                    <div className="w-full h-[1px] bg-cloud"></div>
                                    ...
                                    <div className="flex items-center justify-between">
                                        <Typographie theme="modify" font="ambit" weight="semibold">
                                            #3
                                        </Typographie>
