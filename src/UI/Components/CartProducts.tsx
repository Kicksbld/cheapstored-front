...
const CartProducts = ({index, name, price, quantity, onDelete, onQuantityChange, image}: CartProductProps) => {
    return (
        <div
            className="w-full flex justify-between flex-col md:flex-row gap-4 bg-light border border-cloud rounded-[10px] p-[20px] items-start ">
